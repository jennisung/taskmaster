...
## Lab 37
* Uploads : On the “Add a Task” activity, allow users to optionally select an image to attach to that task. If a user attaches an image to a task, that image should be uploaded to S3, and associated with that task.
* Displaying Files: On the Task detail activity, if there is a file that is an image associated with a particular Task, that image should be displayed within that activity.

### Documentation
![lab 37](screenshots/imagepicket.png)
![lab37](screenshots/addtaskimage.png)
![lab37](screenshots/taskdetailimg.png)
