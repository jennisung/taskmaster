...
public final class Task implements Model {
  ...
  private Task(String id, String title, String body, Temporal.DateTime dateCreated, TaskStatusEnum status) {
    this.id = id;
    this.title = title;
    this.body = body;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String body, Temporal.DateTime dateCreated, TaskStatusEnum status) {
      super.id(id);
      super.title(title)
        .body(body)
